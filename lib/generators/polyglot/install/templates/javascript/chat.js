...
document.addEventListener('turbo:load', () => {
  ...
  // Subscribe to the PolyglotChatChannel
  console.log("Subscribing to PolyglotChatChannel...")
  const subscription = consumer.subscriptions.create(
    { channel: "PolyglotChatChannel", conversation_id: conversationId },
    {
      connected() {
        console.log("✓ Connected to PolyglotChatChannel!")
      },

      disconnected() {
        console.log("✗ Disconnected from PolyglotChatChannel")
      },
