...
module Polyglot
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      desc "Installs Polyglot with real-time multilingual chat"
      ...
      def create_channels
        ...
        template "channels/polyglot_chat_channel.rb", "app/channels/polyglot_chat_channel.rb"
      end
      ...
      def create_initializer
        template "initializer.rb", "config/initializers/polyglot.rb"
      end
